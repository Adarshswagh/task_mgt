...
function Files() {
  ...
  const activeTab = location.pathname === '/board' ? 'Board' : location.pathname === '/list' ? 'List' : location.pathname === '/calendar' ? 'Calendar' : location.pathname === '/files' ? 'Files' : 'Files';
    ...
    <DashboardLayout>
      <div className="max-w-full">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Files View</h2>
          <p className="text-gray-600">Files view content will be displayed here.</p>
        </div>
      </div>
    </DashboardLayout>
  );
